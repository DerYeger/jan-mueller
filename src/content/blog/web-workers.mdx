...
description: 'Exploring web workers in JavaScript and TypeScript — Different approaches and their trade-offs'
heroImage: '/assets/blog/web.jpg'
pubDate: 2026-01-01
layout: '~/layouts/MarkdownLayout.astro'
openGraphImage: 'https://og-image-deryeger.vercel.app/%23%23%20Working%20wonders%20with%20web%20workers.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fjan-mueller.at%2Fog-image.svg'
---
...
As I said, it's neither efficient nor beautiful, but let's have a look at what happens when we run this code in the main thread of a web application.
...
import Comparison from '~/components/blog/examples/worker/Comparison.astro'
...
You'll also notice that the `bidc` run freezed the UI for a short time.
...
A personal favorite of mine is combining Comlink workers with [TanStack Query](https://tanstack.com/query/latest), which is also what I did in my thesis.
