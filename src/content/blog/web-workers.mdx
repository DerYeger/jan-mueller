...
However, if you're ready to deal with a frozen UI for around 40 seconds, you can try it out with <FactorizerExampleButton id="no-worker" value={100001000013699905017} text="very large factors" type="danger" />.
...
Here's the running example with <FactorizerExampleButton id="comlink-worker" value={42} text="small factors" />, <FactorizerExampleButton id="comlink-worker" value={1000036000099} text="large factors" />, and <FactorizerExampleButton id="comlink-worker" value={100001000013699905017} text="very large factors" type="danger" /> for completion.
...
One more time, here's the previous example with <FactorizerExampleButton id="bidc-worker" value={42} text="small factors" />, <FactorizerExampleButton id="bidc-worker" value={1000036000099} text="large factors" />, and <FactorizerExampleButton id="bidc-worker" value={100001000013699905017} text="very large factors" type="danger"/> again.
...
Again, you can play around with different numbers or try <BenchmarkExampleButton size={42} text="small arrays" />, <BenchmarkExampleButton size={1000000} text="medium arrays" />, and <BenchmarkExampleButton size={10000000} text="very large arrays" type="danger" />.
