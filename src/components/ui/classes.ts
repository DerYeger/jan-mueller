export const CLASSES = {
  ...
  INPUT:
    'select-none grow bg-base rounded-sm border border-medium px-2 py-1 text-base disabled:bg-disabled disabled:text-lighter transition-colors focus-visible:focus-ring',
} as const
